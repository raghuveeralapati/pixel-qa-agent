## 🎉 v1.0.0 – Agentic Visual Validation AI Agent (Initial Stable Release)

This release marks the baseline production-ready version of the repository.
...
Workflow
New features are created from dev branch
Feature branches are merged into dev after testing
